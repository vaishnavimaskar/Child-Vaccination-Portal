...
public partial class Parent_Parent : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cn.Open();
        cmd.CommandText = "select parentname from Parent_Registration where username='" + Label1.Text + "'";
        cmd.Connection = cn;
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["search1"] = txtsearch.Text;
        Response.Redirect("~/Parent/search.aspx");
